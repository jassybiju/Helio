          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full  max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-gradient-to-r from-red-50 to-red-100 border-b border-red-200 p-6 flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-slate-900">Appointment Cancellation</h2>
                <p className="text-slate-600 mt-1">Are you sure you want to cancel appointment</p>
              </div>
            </div>
