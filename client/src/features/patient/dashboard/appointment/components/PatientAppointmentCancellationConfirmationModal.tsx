...
const PatientAppointmentCancellationConfirmationModal = ({
  close,
  date,
  fee,
  appointmentId,
  ...
  const { mutate: cancelAppointment } =
    useCancelAndRefundAppointmentMutation(appointmentId);
        ...
        <div className="bg-gradient-to-r from-red-50 to-red-100 border-b border-red-200 p-6 flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-600 mt-1">
              Your doctor has cancelled this appointment. Please choose an
              option below.
            </p>
          </div>
        </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-600 mt-1">
                    Book a new appointment at no extra cost. You have 7 days to reschedule.
                  </p>
                </div>
              </div>
            </div>
