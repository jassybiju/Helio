...
import { useAdminAppointment } from "../hooks/useAdminAppointment";
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-600 mt-1">
          Total {totalCount} appointment created
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <select
          ...
          onChange={(e) => {
              if (e.target.value === "") {
                  return setFilter(prev => ({...prev, page : 1, status : undefined}));
                }
      ...
      {/* Table */}
      <TableComponent data={appointments} columns={columns} />
