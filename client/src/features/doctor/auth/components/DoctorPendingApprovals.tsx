...
const DoctorPendingApprovals = () => {
  ...
  return (
    <>
      <main className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 px-3 sm:px-4 lg:px-6 py-6 sm:py-10 lg:py-12">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-3 sm:p-4 sm:p-8 lg:p-12 space-y-6 sm:space-y-8">
            {/* Header */}
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 space-y-6">
              ...
              <div className="flex justify-center">
                <div
                  className={`w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center p-2 ${currentStatus.bgColor}`}
                >
                  {currentStatus.icon}
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 py-3 border-b border-slate-200">
                  <span className="text-slate-600 text-sm">Doctor Name</span>
                  <span className="font-semibold text-slate-900 break-words text-sm sm:text-base text-left sm:text-right">
                    {user?.email}
                  </span>
                </div>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 py-3 border-b border-slate-200">
                ...
                <div className="flex justify-between items-center py-3 ">
                  <span className="text-slate-600 text-sm">Submitted Date</span>
                  <span className="font-semibold text-slate-900 break-words text-sm sm:text-base text-left sm:text-right">
                ...
                document_url && (
                  <div className="pt-4 border-t border-slate-200">
                    ...
                    <div className="space-y-2">
                      <div className="flex flex-wrap sm:flex-nowrap items-center gap-3 p-3 bg-white rounded-lg border border-slate-200">
                        {" "}
                        ...
                        <button
                          ...
                          className="w-full sm:w-auto text-blue-600 font-medium"
                        >
                          View
                        </button>
                      </div>
                  ...
                  {verification_history.map((response, idx) => {
                    return (
                      ...
                      >
                        ...
                        {expanded === idx && (
                          <div className="p-3 sm:p-4 bg-red-50 border-t border-slate-200 space-y-4">
                            {/* Submitted At */}
                            <div>
            ...
            {/* Actions */}
            <div className="flex flex-col sm:flex-row gap-3 sm:p-4 pt-4">
