            ...
            <>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="hidden sm:inline text-sm font-medium text-slate-900">{data.user.email.split(' ')[0]}</span>
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg border border-slate-200 shadow-lg">
                    ...
                    <button  onClick={logout} className="w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-slate-100 rounded-b-lg border-t border-slate-200">
                      Logout
                    </button>
                  </div>
                )}
