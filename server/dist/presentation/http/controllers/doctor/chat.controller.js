...
export class DoctorChatController {
    ...
    getChat = async (req, res, next) => {
        try {
            ...
            const response = await this._getChat.execute(userId, chatSessionId, USER_ROLES.DOCTOR);
    ...
    getChatList = async (req, res, next) => {
        try {
            ...
            const response = await this._getChatList.execute(userId, USER_ROLES.DOCTOR);
    ...
    sendMessage = async (req, res, next) => {
        try {
            ...
            const response = await this._sendMessage.execute(userId, chatSessionId, USER_ROLES.DOCTOR, content);
            return apiResponse(res, HTTPStatus.OK, successResponse(response, "Chat Send Successfuly"));
        }
        catch (error) {
            next(error);
