...
const addSpecialty = new CreateSpecialtyUseCase(specialtyRepo, idGenerator, loggerService);
const removeSpecialty = new RemoveSpecialtyUseCase(specialtyRepo, loggerService);
const getAllSpecialtyUseCase = new GetAllSpecialtyUseCase(loggerService, specialtyRepo);
export const specialityController = new SpecialtyController(getSpecialityUseCase, addSpecialty, removeSpecialty, getAllSpecialtyUseCase);
//# sourceMappingURL=specialty.di.js.map