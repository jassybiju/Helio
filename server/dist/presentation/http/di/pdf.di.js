...
const generatePatientAppointmentPDF = new GeneratePatientAppointmentPDFUseCase(logger, patientRepo, doctorRepo, consultationRepo, appointmentRepo, templateRenderer, pdfGenerator);
const generatePatientInvoicePDF = new GeneratePatientInvoicePDFUseCase(logger, patientRepo, appointmentRepo, doctorRepo, templateRenderer, pdfGenerator);
const pdfDispatcher = new PdfDispatcher(new Map([
...
//# sourceMappingURL=pdf.di.js.map