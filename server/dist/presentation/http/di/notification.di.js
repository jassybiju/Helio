...
const getAllNotificationuseCase = new GetAllNotificationuseCase(logger, notificationRepo);
export const notificationController = new NotificationController(getAllNotificationuseCase);
//# sourceMappingURL=notification.di.js.map