...
const getWalletUseCase = new GetWalletUseCase(logger, walletRepo, transactionRepo);
const addMoneyUseCase = new AddMoneyUseCase(logger, walletRepo, transactionRepo, idGenerator, razorpay, uow);
const verifyAddMoney = new AddMoneyVerifyUseCase(logger, walletRepo, transactionRepo);
export const walletController = new WalletController(getWalletUseCase, addMoneyUseCase, verifyAddMoney);
//# sourceMappingURL=wallet.di.js.map