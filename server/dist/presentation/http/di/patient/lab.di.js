...
const getAllLabReport = new GetPatientLabReportUseCase(logger, patientRepo, labRepo, fileUpload);
const uploadLabReport = new UploadPatientLabReportUseCase(logger, patientRepo, labRepo, fileUpload);
export const labController = new PatientLabReportController(getAllLabReport, uploadLabReport);
//# sourceMappingURL=lab.di.js.map