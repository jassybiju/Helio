...
const patientAddReviewUseCase = new PatientAddReviewUseCase(logger, patientRepo, doctorRepo, reviewRepository, appointmentRepo, idGenerator);
export const patientReviewController = new PatientReviewController(patientAddReviewUseCase);
//# sourceMappingURL=review.di.js.map