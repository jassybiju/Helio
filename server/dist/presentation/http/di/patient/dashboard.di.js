...
const getPatientDashboardUseCase = new GetPatientDashboardUseCase(logger, patientRepo, appointmentRepo);
export const patientDashboardController = new PatientDashboardController(getPatientDashboardUseCase);
