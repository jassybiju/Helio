...
const searchDoctorUseCase = new SearchDoctorsUseCase(loggerService, doctorShiftRepo, doctorRepo, slotGenerator, fileUpload);
const getSlotsUseCase = new GetSlotUseCase(loggerService, doctorRepo, doctorShiftRepo, blockSlotRepo, slotGenerator, appointmentRepo, reviewRepo, patientRepo, fileUpload);
export const patientDoctorController = new PatientDoctorController(searchDoctorUseCase, getSlotsUseCase);
//# sourceMappingURL=search.di.js.map