...
const patientProfileCompleteUseCase = new CompletePatientProfileUseCase(loggerService, patientRepo);
const patientGetProfileUseCase = new GetPatientProfileUseCase(loggerService, patientRepo, fileUpload);
const patientAddAllergenUseCase = new AddPatientAllergenUseCase(loggerService, patientRepo, idGenerator);
const patientRemoveAllergenUseCase = new RemovePatientAllergenUseCase(logger, patientRepo);
const patientAddConditionUseCase = new AddPatientConditionUseCase(logger, patientRepo, idGenerator);
const patientRemoveConditionUseCase = new RemovePatientConditionUseCase(logger, patientRepo);
...
const patientUpdateProfilePicUseCase = new PatientUpdateProfilePictureUseCase(logger, patientRepo, fileUpload);
export const patientProfileController = new PatientProfileController(patientProfileCompleteUseCase, patientGetProfileUseCase, patientAddAllergenUseCase, patientRemoveAllergenUseCase, patientAddConditionUseCase, patientRemoveConditionUseCase, patientChangePasswordUseCase, patientUpdateProfileUseCase, patientUpdateProfilePicUseCase);
