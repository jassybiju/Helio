...
const patientValidator = new PatientValidator(patientRepo, bcryptPasswordService);
const registerPatientUseCase = new RegisterPatientUseCase(patientValidator, patientRepo, bcryptPasswordService, nanoidGenerator, loggerService, otpService, otpRepo, emailService);
const verifyPatientUseCase = new VerifyOTPUseCase(loggerService, otpRepo, patientRepo, doctorRepo, walletRepo, nanoidGenerator);
const resendPatientOTPUseCase = new ResendOTPUseCase(loggerService, otpRepo, otpService, messageQueue);
const loginPatientUseCase = new LoginPatientUseCase(loggerService, patientRepo, patientValidator, accessTokenService, refreshTokenService, sessionRepo);
...
const googleLoginUseCase = new GoogleLoginUseCase(loggerService, googleAuthService, patientRepo, doctorRepo, nanoidGenerator, accessTokenService, refreshTokenService, sessionRepo, walletRepo);
export const authController = new PatientAuthController(registerPatientUseCase, resendPatientOTPUseCase, verifyPatientUseCase, loginPatientUseCase, forgetPasswordUseCase, resetPasswordUseCase, googleLoginUseCase);
