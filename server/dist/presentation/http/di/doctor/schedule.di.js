...
const setScheduleUseCase = new SetDoctorScheduleUseCase(loggerService, uow, doctorShiftRepo, idGenerator, doctorRepo);
const getDoctorScheduleUseCase = new GetDoctorScheduleUseCase(loggerService, doctorShiftRepo);
const deleteDoctorScheduleUseCase = new DeleteDoctorScheduleUseCase(loggerService, doctorRepo, doctorShiftRepo);
export const doctorScheduleController = new DoctorScheduleController(setScheduleUseCase, getDoctorScheduleUseCase, deleteDoctorScheduleUseCase);
//# sourceMappingURL=schedule.di.js.map