...
const getDoctorDashboardUseCase = new GetDoctorDashboardUseCase(logger, doctorRepo, appointmentRepo, patientRepo, walletRepo, transactionRepo);
export const doctorDashboardController = new DoctorDashboardController(getDoctorDashboardUseCase);
//# sourceMappingURL=dashboard.di.js.map