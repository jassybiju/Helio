...
doctorVerificationRoutes.get("", doctorVerificationController.getVerificationDetails);
doctorVerificationRoutes.patch("/resubmit", documentUpload.single("document"), doctorVerificationController.resubmitVerification);
