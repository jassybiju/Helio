...
notificationRouter.use(authorizeMiddleware([USER_ROLES.DOCTOR, USER_ROLES.PATIENT, USER_ROLES.ADMIN]));
notificationRouter.use(checkBlockMiddleware.handle);
notificationRouter.get("/", validate(getAllNotificationSchema), notificationController.getAll);
