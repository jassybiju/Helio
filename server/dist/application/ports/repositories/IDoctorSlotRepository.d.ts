...
export interface IDoctorSlotRepository {
    ...
    findAllWithFilters(doctorId: string, params: IDoctorSlotFilters): Promise<{
        slots: DoctorSlot[];
        totalCount: number;
    }>;
    /**
    ...
    findNextAvailableSlots(doctorIds: string[], date?: Date, consultationType?: CONSULTATION_TYPE): Promise<Map<string, Date>>;
}
//# sourceMappingURL=IDoctorSlotRepository.d.ts.map