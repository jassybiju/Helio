import type { APPOINTMENT_STATUS, BOOKING_PERIOD } from "#domain/common/enums/appointment.enum.js";
...
export interface IAppointmentRepository {
    ...
    findActiveInRange(doctorId: string, start: Date, end: Date): Promise<Appointment[]>;
...
//# sourceMappingURL=IAppointmentRepository.d.ts.map