...
export class DoctorAddPrescriptionUseCase {
    _logger;
    _doctorRepo;
    _consultationRepo;
    _appointmentRepo;
    ...
    async execute(doctorId, appointmentId, data) {
        ...
        const prescription = new Prescription(data.name, data.foodTiming, data.timings, data.durationInDays, data.instruction);
        consultation.addPrescription(prescription);
        await this._consultationRepo.update(consultation);
    }
}
//# sourceMappingURL=DoctorAddPrescriptionUseCase.js.map