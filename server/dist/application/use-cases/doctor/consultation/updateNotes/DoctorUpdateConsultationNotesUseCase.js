...
export class DoctorUpdateConsultationNotesUseCase {
    _logger;
    _doctorRepo;
    _consultationRepo;
    _appointmentRepo;
    ...
    async execute(doctorId, appointmentId, data) {
        ...
        consultation.addNotes(data.clinicalObservations, data.primaryDiagnosis, data.generalAdvice, data.quickNote);
        await this._consultationRepo.update(consultation);
    }
}
//# sourceMappingURL=DoctorUpdateConsultationNotesUseCase.js.map