...
export class GeneratePatientInvoicePDFUseCase {
    _logger;
    _patientRepo;
    _appointmentRepo;
    _doctorRepo;
    _templateRenderer;
    _pdfGenerator;
    constructor(_logger, _patientRepo, _appointmentRepo, _doctorRepo, _templateRenderer, _pdfGenerator) {
    ...
    async execute(request) {
        ...
        const view = PatientAppointmentPdfMapper.toView(appointment, patient, doctor);
        const html = await this._templateRenderer.render(PDF_TYPE.PATIENT_INVOICE, view);
        return this._pdfGenerator.generate(html);
    }
}
//# sourceMappingURL=GeneratePatientInvoicePDFUseCase.js.map