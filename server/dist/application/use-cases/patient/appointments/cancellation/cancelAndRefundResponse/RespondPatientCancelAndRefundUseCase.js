...
export class RespondPatientCancelAndRefundAppointmentUseCase {
    _logger;
    _patientRepo;
    _appointmentRepo;
    _walletRepo;
    ...
    async execute(patientId, appointmentId) {
        ...
        return this._uow.execute(async (session) => {
            ...
            if (appointment.status !== APPOINTMENT_STATUS.DOCTOR_CANCELLATION_REQUESTED) {
                throw new ConflictError("Appointment is not waiting for patient response");
            }
...
//# sourceMappingURL=RespondPatientCancelAndRefundUseCase.js.map