import type { IDoctorGetChatUseCase } from "@application/ports/use-cases/doctor/chat/IDoctorGetChatUseCase.ts";
import type { IDoctorGetChatDTO } from "./IPatientGetChatDTO.ts";
