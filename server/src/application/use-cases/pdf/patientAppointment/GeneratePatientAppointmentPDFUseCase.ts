...
import { PatientAppointmentPdfMapper } from "./PatientAppointmentPdfMapper.ts";
import { PDF_TYPE } from "@shared/types/pdf.type.ts";
import type { Readable } from "stream";

export class GeneratePatientAppointmentPDFUseCase implements IPdfUseCase {
  constructor(
