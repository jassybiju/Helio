import { TRANSACTION_STATUS, type WALLET_TYPE } from "@domain/common/enums/wallet.enum.ts";

export class WalletTransaction {
  constructor(
    private readonly _id : string,
    private readonly _walletId : string,
    private readonly _type : WALLET_TYPE,
  ...
  createTransaction({id , walletId, type, amount , referenceId, description} : {id : string, walletId : string, amount : number, type : WALLET_TYPE, referenceId? : string | null, description? :string | null}){
